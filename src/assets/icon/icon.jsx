  ...
  return (
    ...
    >
      <path
        fill="#000"
        fillRule="evenodd"
        d="M13.468 3.73l-.742-.434s-.776-2.11-.842-2.254C11.637.447 10.961 0 10.284 0H8.42c-.675 0-1.349.446-1.613 1.068-.054.118-.821 2.228-.821 2.228l-.734.436s-2.236-.39-2.392-.404c-.64-.084-1.365.279-1.704.866l-.93 1.612a1.813 1.813 0 00.118 1.931c.074.106 1.519 1.835 1.519 1.835s-.012.285-.012.428c0 .303.01.429.01.429S.42 12.157.328 12.285c-.392.512-.44 1.322-.102 1.909l.931 1.612c.338.585 1.06.945 1.731.863.13-.012 2.343-.402 2.343-.402l.745.425s.778 2.122.843 2.265c.247.596.924 1.043 1.602 1.043h1.862c.675 0 1.348-.446 1.613-1.068.054-.117.83-2.232.83-2.232l.73-.431 2.38.402c.646.085 1.372-.278 1.71-.865l.932-1.612a1.813 1.813 0 00-.119-1.931c-.074-.106-1.52-1.826-1.52-1.826s.013-.291.013-.437c0-.303-.01-.43-.01-.43s1.443-1.727 1.534-1.855c.392-.512.44-1.322.102-1.909l-.931-1.612a1.813 1.813 0 00-1.732-.863c-.129.012-2.347.399-2.347.399zm-2.526.575l.135.45.431.183c.408.174.793.397 1.147.664l.375.282.457-.108c.664-.158 2.225-.42 2.374-.438.087-.01.835 1.286.783 1.356-.09.12-1.097 1.34-1.566 1.837l-.321.34.055.466a5.579 5.579 0 010 1.327l-.055.465.321.34c.469.496 1.475 1.717 1.566 1.838.052.07-.731 1.361-.783 1.355-.15-.019-1.71-.28-2.374-.438l-.457-.108-.375.282c-.354.267-.74.49-1.147.664l-.431.184-.135.449c-.195.653-.749 2.135-.808 2.273-.034.08-1.53.08-1.565 0-.059-.138-.612-1.62-.807-2.273l-.135-.45-.431-.183a5.494 5.494 0 01-1.147-.664l-.375-.282-.457.109c-.664.157-2.225.418-2.375.437-.086.01-.835-1.286-.782-1.356.09-.12 1.097-1.34 1.566-1.837l.321-.34-.056-.465a5.569 5.569 0 010-1.328l.056-.465-.321-.34C3.157 8.035 2.15 6.814 2.06 6.693c-.053-.07.696-1.365.782-1.355.15.018 1.71.28 2.375.438l.457.108.375-.282c.354-.267.74-.49 1.147-.664l.431-.184.135-.449c.195-.653.749-2.135.807-2.273.035-.08 1.531-.08 1.565 0 .06.138.613 1.62.808 2.273zM9.352 13a3 3 0 110-6 3 3 0 010 6zm1-3a1 1 0 11-2 0 1 1 0 012 0z"
        clipRule="evenodd"
        opacity="0.24"
      ></path>
    </svg>
  ...
  return (
    ...
    >
      ...
      <path
        fill="#fff"
        fillRule="evenodd"
        d="M11.998 8.666l-.534.54a.925.925 0 00-.264.653c0 .254.088.47.264.647L14.928 14l-3.464 3.494a.885.885 0 00-.264.647c0 .249.088.467.264.654l.534.532c.18.182.397.273.65.273.256 0 .47-.091.64-.273l4.641-4.68A.858.858 0 0018.2 14a.896.896 0 00-.27-.654l-4.641-4.68a.87.87 0 00-.642-.266.91.91 0 00-.649.266z"
        clipRule="evenodd"
      ></path>
    </svg>
  );
...
export const ShareIcon = () => {
  return (
    ...
    >
      <path
        fill="#000"
        d="M8.556 0L14 5.6l-5.444 5.6V7.92C4.666 7.92 1.944 9.2 0 12c.778-4 3.111-8 8.556-8.8V0z"
        opacity="0.24"
      ></path>
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fill="#000"
        fillRule="evenodd"
        d="M3 6a3 3 0 100-6 3 3 0 000 6zm11 0a3 3 0 100-6 3 3 0 000 6zm14-3a3 3 0 11-6 0 3 3 0 016 0z"
        clipRule="evenodd"
      ></path>
    </svg>
  );
